...
**Клучни наоди:** MPC постигнува 95.7-97.7% од теоретскиот максимум (Perfect Foresight) во сите 6 земји, конзистентно надминувајќи ги едноставните rule-based правила (91.4-96.0%). Капацитетот на батеријата е пропорционален на просечното производство по земја (од Netherlands=124 до Germany=14,043). Целосен извештај: [research/RQ3_извештај.md](research/reports/RQ3_извештај.md).
...
**Клучни наоди:** Стратегијата е асиметрично чувствителна на насоката на грешка - преценување на идни цени е поскапа грешка од потценување, конзистентно низ сите земји. Несигурноста во PV производство е практично безначајна (~0% загуба), додека несигурноста во цена дава мерлива загуба (~1.25%) - силна потврда дека подобрувањето на предвидувањето на цени носи далеку поголема практична вредност. Целосен извештај: [research/RQ4_извештај.md](research/reports/RQ4_извештај.md).
...
- `research/data/` - суровини и обработени податоци (features, merge-нати податочни множества по земја)
...
- `research/RQ1_извештај.md`, `RQ2_извештај.md`, `RQ3_извештај.md`, `RQ4_извештај.md` - детални извештаи за секое истражувачко прашање
